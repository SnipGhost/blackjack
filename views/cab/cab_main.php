		...
		<div id="kit" class="tabs block">
			...
			<div class="block-content-cab">
				<form enctype="multipart/form-data" action="/<?=BASE_URI?>upload" method="POST">	
					...
					<div style="margin-bottom: 10px">
						Разработанный нами Комплекс Избирательных Технологий (КИТ) позволяет Вам планировать и следить как за собственными результатами агитационных мероприятий, так и за результаты конкурентов. С помощью предоставляемого инструмента Вы (или ваш избирательный штаб) сможете адекватно, основываюсь на подсчетах, оценить текущую ситуацию и ответить на вопрос: «Что будет, если выборы состоятся завтра?». Примечание: мы не являемся частью избирательного штаба. Мы предоставляем аналитическую поддержку в виде инструмента планирования и мониторинга избирательной кампании.
					</div>
                    <br>
					...
					<img class="image" src="img/guide/1.png"/>
                    <img class="image" src="img/guide/2.png"/>
                    <img class="image" src="img/guide/3.png"/>
                    <div style="margin-bottom: 10px">
